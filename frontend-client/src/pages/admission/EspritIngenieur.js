...
import file1 from "../../assets/files/grille tarifaire 2021-2022 Ecole d'ingénieurs Tunisiens(sans foyer).pdf"
import file2 from "../../assets/files/grille tarifaire 2021-2022 Ecole d'ingénieurs_International_2.pdf"
        ...
        <div className="container">
          ...
          <Row>
            <Col md={12}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                <LinkDuo target="_blank" rel="noopener noreferrer" to={"mailto:reclamation.admission2021@esprit.tn"}>
          ...
          <Row style={{ marginBottom: "60px" }}>
            <Col md={8} className="pad-right-desk-100">
              ...
              <br />
              <h3>En 1ère année :</h3>
              <p>Être titulaire d'un baccalauréat scientifique, économique, technique ou diplôme équivalent.</p>
              <h3>En 2ème année :</h3>
              <p>
            ...
            <Col className="gris">
              ...
              <Row>
                <Col>
                  <LinkDuo className="custom-button btn width100" to={"/admission/resultat-cameroun-2021"}>
