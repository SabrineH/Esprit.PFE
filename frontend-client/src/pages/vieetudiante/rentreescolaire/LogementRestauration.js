        ...
        <section className="our-blog extract main-blog dynamic-margin">
          ...
          <div className="container space-items">
            ...
            <Row style={{ textAlign: "center", justifyContent: "center" }}>
              <Col>
                <h1 style={{ color: "#cd1211" }}>
                  Ouverture des pré-inscriptions en ligne au foyer à partir du 7 juillet 2021 jusqu’à épuisement des
                  disponibilités
                </h1>
            ...
            <Row>
              <Col>
                <p>
                  La date limite pour la confirmation du renouvellement des inscriptions au foyer pour filles et
                  étudiants prépa est fixée au <strong style={{ color: "red" }}>21 Juin 2020.</strong>
                </p>
              </Col>
            </Row>
            {/* <Row>
...
const list = {
  ...
  list: [
    ...
    <LinkDuo rel="noopener noreferrer" target="_blank" to={file3}>
      Contrat à usage d'habitation (Bloc 2 pour garçons - Résidence El Amen) (Signé)
    </LinkDuo>,
